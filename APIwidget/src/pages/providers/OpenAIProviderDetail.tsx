                        ...
                        {usage.models_used.map((model) => {
                          ...
                          return (
                            <TableRow key={model.model}>
                              ...
                              <TableCell align="right">{model.tokens.toLocaleString()}</TableCell>
                              <TableCell align="right">${(model.cost / 100).toFixed(2)}</TableCell>
                  ...
                  <Box sx={{ display: 'flex', flexWrap: 'wrap', gap: 2 }}>
                    <Box sx={{ flex: '1 1 30%', minWidth: 250 }}>
                      <Paper sx={{ p: 2, height: '100%', bgcolor: 'rgba(16, 185, 129, 0.05)' }}>
                        ...
                        <Typography variant="body2">
                          Your prompt-to-completion ratio is {(usage.prompt_tokens / usage.completion_tokens).toFixed(1)}:1.
                          Consider using more efficient prompts to reduce token consumption.
                        </Typography>
                      </Paper>
                    </Box>
                    ...
                    <Box sx={{ flex: '1 1 30%', minWidth: 250 }}>
                      <Paper sx={{ p: 2, height: '100%', bgcolor: 'rgba(99, 102, 241, 0.05)' }}>
                        ...
                        <Typography variant="body2">
                          {usage.models_used.some(m => m.model.includes('gpt-4')) ?
                    ...
                    <Box sx={{ flex: '1 1 30%', minWidth: 250 }}>
                      <Paper sx={{ p: 2, height: '100%', bgcolor: 'rgba(249, 115, 22, 0.05)' }}>
                        ...
                        <Typography variant="body2">
                          ...
                          This can significantly reduce your token usage for repetitive tasks.
                        </Typography>
                      </Paper>
                    </Box>
                  </Box>
