                  ...
                  {filteredData
                    ...
                    .map((request) => (
                      ...
                      >
                        ...
                        <TableCell>{getProviderName(request.provider)}</TableCell>
                        <TableCell>{request.model}</TableCell>
                        <TableCell align="right">
                          {request.promptTokens + request.completionTokens}
                          <Typography variant="caption" color="text.secondary" sx={{ display: 'block' }}>
                            {request.promptTokens} in / {request.completionTokens} out
                          </Typography>
                        </TableCell>
                        <TableCell align="right">{formatCost(request.cost)}</TableCell>
