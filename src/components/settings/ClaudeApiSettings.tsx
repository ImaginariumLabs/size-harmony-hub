...
import { validateApiKey } from '../../services/claudeService';
        ...
        <Grid item xs={12} sx={{ mt: 2 }}>
          ...
          <Box sx={{ mt: 3, mb: 2, p: 2, bgcolor: 'rgba(121, 99, 210, 0.1)', borderRadius: 1, border: '1px solid rgba(121, 99, 210, 0.2)' }}>
            ...
            <Box component="table" sx={{ width: '100%', borderCollapse: 'collapse', '& th, & td': { p: 1, borderBottom: '1px solid rgba(255, 255, 255, 0.1)' } }}>
              ...
              <Box component="tbody">
                <Box component="tr">
                  <Box component="td">Claude 3.5 Sonnet</Box>
                  <Box component="td">$0.003</Box>
                  <Box component="td">$0.015</Box>
                </Box>
                <Box component="tr">
                  <Box component="td">Claude 3 Opus</Box>
                  <Box component="td">$0.015</Box>
                  <Box component="td">$0.075</Box>
                </Box>
                <Box component="tr">
                  <Box component="td">Claude 3 Sonnet</Box>
                  <Box component="td">$0.003</Box>
                  <Box component="td">$0.015</Box>
                </Box>
                <Box component="tr">
                  <Box component="td">Claude 3 Haiku</Box>
                  <Box component="td">$0.00125</Box>
                  <Box component="td">$0.00375</Box>
                </Box>
              </Box>
            </Box>
          ...
          <Typography variant="body2" color="text.secondary">
            <Chip label="Free Credits" size="small" color="primary" sx={{ mr: 1 }} />
            Anthropic offers free credits to new users to help you get started with Claude API.
          </Typography>
        </Grid>
      </Grid>
    </Paper>
