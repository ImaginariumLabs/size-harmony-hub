...
interface ProviderUsageOverviewChartProps {
  data: Array<{
    date: string;
    value: number;
    [key: string]: unknown;
...
const ProviderUsageOverviewChart: React.FC<ProviderUsageOverviewChartProps> = ({
  data,
...
export default ProviderUsageOverviewChart;
