...
interface ProviderUsageDetailsTableProps {
  data: UsageDetail[];
  title?: string;
}
...
const ProviderUsageDetailsTable: React.FC<ProviderUsageDetailsTableProps> = ({
  data,
  title = 'Usage Details',
}) => {
...
export default ProviderUsageDetailsTable;
