...
import { Box, AppBar, Toolbar, Drawer, List, ListItem, ListItemIcon, ListItemText, Menu, MenuItem, Switch, FormControlLabel, Typography, IconButton, Divider, Tooltip, Button } from '@mui/material';
    ...
    <Box sx={{
      ...
      <AppBar
        ...
        sx={{
          ...
          boxShadow: 'none',
          ...(isElectronEnv && { WebkitAppRegion: 'drag' })
        }}
      >
        <Toolbar sx={{ minHeight: 48, px: 2 }}>
          <IconButton
            ...
            sx={{ mr: 2, ...(isElectronEnv && { WebkitAppRegion: 'no-drag' }) }}
          >
            <MenuIcon />
          </IconButton>
          ...
          {onToggleWidget && (
            <FormControlLabel
              ...
              sx={{
                mr: 2,
                ...(isElectronEnv && { WebkitAppRegion: 'no-drag' }),
          ...
          {/* Alert Center */}
          <Box sx={{ ...(isElectronEnv && { WebkitAppRegion: 'no-drag' }) }}>
            <AlertCenter />
          </Box>
          ...
          <Tooltip title="Account">
            <IconButton
              ...
              sx={{ ...(isElectronEnv && { WebkitAppRegion: 'no-drag' }) }}
            >
              <AccountCircleIcon />
            </IconButton>
          </Tooltip>
          ...
          {isElectronEnv && (
            <Box sx={{ ml: 2, display: 'flex', WebkitAppRegion: 'no-drag' }}>
              <IconButton
                color="inherit"
      ...
      >
        ...
        <Box sx={{ overflow: 'auto', px: 1, py: 2 }}>
          ...
          <List>
            ...
            <ListItem button onClick={() => navigate('/settings/alerts')}>
              <ListItemIcon>
                <SettingsIcon />
              </ListItemIcon>
