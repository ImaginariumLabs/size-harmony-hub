  ...
  "inline-flex items-center justify-center gap-2 whitespace-nowrap rounded-md text-sm font-medium ring-offset-background transition-all duration-300 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-2 disabled:pointer-events-none disabled:opacity-50 [&_svg]:pointer-events-none [&_svg]:size-4 [&_svg]:shrink-0 active:scale-[0.98]",
  {
    variants: {
      variant: {
        ...
        gradient: "bg-gradient-to-r from-primary to-purple-400 text-primary-foreground hover:brightness-105 shadow-md hover:shadow-lg",
        glow: "bg-primary text-primary-foreground hover:bg-primary/90 shadow-[0_0_15px_rgba(155,135,245,0.5)] hover:shadow-[0_0_20px_rgba(155,135,245,0.6)]",
        glass: "bg-white/20 backdrop-blur-md border border-white/30 text-foreground hover:bg-white/30 shadow-sm hover:shadow",
      },
      size: {
